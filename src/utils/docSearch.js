...
export const DOC_INDEX = [
  ...
  },
  {
    ...
    module: 'Pulse AI',
    category: 'Pulse Tags',
    entities: ['pulse', 'tag', 'tags'],
    actions: ['create', 'configure', 'manage', 'add'],
    keywords: ['pulse tags', 'conversation tags', 'chat tags'],
    aliases: ['pulse conversation tags', 'inbox tags'],
    intents: [
      'create pulse tags',
      'configure pulse tags',
      'manage conversation tags',
      'add tags to pulse conversations',
    ],
    phrases: ['pulse tags', 'conversation tags', 'create pulse tag'],
    description: 'Create and manage tags used to categorize Pulse conversations.',
    readingTime: '4 min',
  },
  {
    label: 'Call Providers',
    to: '/docs/Call-Settings/providers',
    entities: ['call', 'calls', 'provider', 'providers', 'telephony'],
    actions: ['configure', 'setup', 'connect'],
    phrases: ['call providers', 'call settings', 'configure call provider'],
  },
  {
    label: 'Call Logs',
    to: '/docs/Call-Settings/call-logs',
    entities: ['call', 'calls', 'log', 'logs'],
    actions: ['view', 'review', 'search', 'filter'],
    phrases: ['call logs', 'call history', 'view call logs'],
  },
  {
  ...
  },
  {
    ...
    phrases: ['configure leads', 'lead scoring', 'lead scoring settings'],
  },
  {
    label: 'Lead Import',
    to: '/docs/Configure/lead-import',
    entities: ['lead', 'leads', 'import'],
    actions: ['configure', 'setup', 'import', 'upload'],
    phrases: ['lead import', 'import leads', 'configure lead import'],
  },
  {
  ...
  },
  {
    ...
    entities: ['deal', 'deals', 'sales model', 'buyer type', 'deal origin'],
    actions: ['configure', 'setup'],
    phrases: ['deal settings', 'sales model', 'buyer type behavior'],
  },
  {
    label: 'Deal Scoring',
    to: '/docs/Configure/deal-scoring',
    entities: ['deal', 'deals', 'scoring'],
    actions: ['configure', 'setup', 'score'],
    phrases: ['deal scoring', 'configure deal scoring'],
  },
  {
    label: 'Deal Import',
    to: '/docs/Configure/deal-import',
    entities: ['deal', 'deals', 'import'],
    actions: ['configure', 'setup', 'import', 'upload'],
    phrases: ['deal import', 'import deals', 'configure deal import'],
  },
  {
    label: 'Contact Import',
    to: '/docs/Configure/contact-import',
    entities: ['contact', 'contacts', 'import'],
    actions: ['configure', 'setup', 'import', 'upload'],
    phrases: ['contact import', 'import contacts', 'configure contact import'],
  },
  {
    label: 'Organization Import',
    to: '/docs/Configure/organization-import',
    entities: ['organization', 'organizations', 'import'],
    actions: ['configure', 'setup', 'import', 'upload'],
    phrases: ['organization import', 'import organizations', 'configure organization import'],
  },
  {
    label: 'Activities Import',
    to: '/docs/Configure/activities-import',
    entities: ['activity', 'activities', 'task', 'tasks', 'import'],
    actions: ['configure', 'setup', 'import', 'upload'],
    phrases: ['activities import', 'import activities', 'import tasks'],
  },
  {
    label: 'Catalog',
    to: '/docs/Configure/catalog',
    entities: ['catalog', 'product', 'products', 'service', 'services'],
    actions: ['configure', 'setup', 'create', 'manage'],
    phrases: ['catalog', 'product catalog', 'configure catalog'],
  },
  {
    label: 'Tags',
